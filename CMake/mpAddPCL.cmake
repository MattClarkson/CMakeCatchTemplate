...
if(BUILD_PCL AND NOT BUILD_Eigen)
  ...
  message(STATUS "Forcing BUILD_Eigen to ON due to BUILD_PCL being ON.")
endif()

if(BUILD_PCL AND NOT BUILD_FLANN)
  set(BUILD_FLANN ON CACHE BOOL "Build FLANN." FORCE)
  message(STATUS "Forcing BUILD_FLANN to ON due to BUILD_PCL being ON.")
endif()

if(BUILD_PCL_VIS AND NOT BUILD_PCL)
  set(BUILD_PCL_VIS OFF CACHE BOOL "Build PCL Visualisation tools." FORCE)
  message(STATUS "Forcing BUILD_PCL_VIS to OFF due to BUILD_PCL being OFF.")
endif()

if(BUILD_PCL_VIS AND BUILD_Python_Boost)
  set(BUILD_PCL_VIS OFF CACHE BOOL "Build PCL Visualisation tools." FORCE)
  message(STATUS "Forcing BUILD_PCL_VIS to OFF due to BUILD_Python_Boost being ON.")
endif()

if(BUILD_PCL_VIS AND BUILD_Python_PyBind)
  set(BUILD_PCL_VIS OFF CACHE BOOL "Build PCL Visualisation tools." FORCE)
  message(STATUS "Forcing BUILD_PCL_VIS to OFF due to BUILD_Python_PyBind being ON.")
endif()
...
if(BUILD_VTK AND APPLE AND BUILD_PCL AND BUILD_PCL_VIS AND "${VTK_VERSION}" STREQUAL "${DEFAULT_VTK_VERSION}")
  ...
  message(STATUS "Forcing VTK_VERSION to ${VTK_VERSION} as you are on Mac OSX and both BUILD_PCL and BUILD_PCL_VIS are on.")
endif()
